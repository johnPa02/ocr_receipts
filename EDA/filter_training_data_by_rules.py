...
from utils.utility import type_map
from utils.spell_check import validate_TOTAL_COST_amount
...
def filter_training_data_by_rules(csv_file, output_csv_file, output_filtered_dir, img_dir=None):
    with open(csv_file, encoding='utf-8') as csv_file:
        ...
        with open(output_csv_file, mode='w', encoding='utf-8') as employee_file:
...
if __name__ == '__main__':
    from config import train_img_dir, raw_csv, filtered_train_img_dir, filtered_csv
